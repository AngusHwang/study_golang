...
func (a *Artist) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     a.ID,
		Type:   "Artist",
		Fields: make([]*Field, 6),
	...
	if buf, err = json.Marshal(a.ExternalURL); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(a.PhoneNumber); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(a.Discord); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(a.Recommender); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
...
func (pa *Partnership) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     pa.ID,
		Type:   "Partnership",
		Fields: make([]*Field, 5),
	...
	if buf, err = json.Marshal(pa.Company); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(pa.Content); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
...
func (s *Store) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     s.ID,
		Type:   "Store",
		Fields: make([]*Field, 7),
	...
	if buf, err = json.Marshal(s.Food); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "[]string",
	...
	if buf, err = json.Marshal(s.OnFoot); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(s.SentAt); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "time.Time",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case menu.Table:
		...
		return n, nil
	case partnership.Table:
		query := c.Partnership.Query().
			Where(partnership.ID(id))
		query, err := query.CollectFields(ctx, "Partnership")
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
