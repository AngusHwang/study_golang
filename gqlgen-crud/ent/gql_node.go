...
func (m *Member) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(m.Nick); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(m.Team); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(m.Detail); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(m.Img); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case member.Table:
		query := c.Member.Query().
			Where(member.ID(id))
		query, err := query.CollectFields(ctx, "Member")
		if err != nil {
			return nil, err
		}
