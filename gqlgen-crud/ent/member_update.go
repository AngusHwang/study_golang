...
func (mu *MemberUpdate) SetNick(s string) *MemberUpdate {
	mu.mutation.SetNick(s)
	return mu
}

// SetNillableNick sets the "nick" field if the given value is not nil.
func (mu *MemberUpdate) SetNillableNick(s *string) *MemberUpdate {
	if s != nil {
		mu.SetNick(*s)
	}
	return mu
...
func (mu *MemberUpdate) SetTeam(s string) *MemberUpdate {
	mu.mutation.SetTeam(s)
	return mu
}

// SetNillableTeam sets the "team" field if the given value is not nil.
func (mu *MemberUpdate) SetNillableTeam(s *string) *MemberUpdate {
	if s != nil {
		mu.SetTeam(*s)
	}
	return mu
...
func (mu *MemberUpdate) SetDetail(s string) *MemberUpdate {
	mu.mutation.SetDetail(s)
	return mu
}

// SetNillableDetail sets the "detail" field if the given value is not nil.
func (mu *MemberUpdate) SetNillableDetail(s *string) *MemberUpdate {
	if s != nil {
		mu.SetDetail(*s)
	}
	return mu
...
func (mu *MemberUpdate) SetImg(s string) *MemberUpdate {
	mu.mutation.SetImg(s)
	return mu
}

// SetNillableImg sets the "img" field if the given value is not nil.
func (mu *MemberUpdate) SetNillableImg(s *string) *MemberUpdate {
	if s != nil {
		mu.SetImg(*s)
	}
	return mu
...
func (mu *MemberUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.Nick(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := mu.mutation.Img(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
...
// SetNick sets the "nick" field.
func (muo *MemberUpdateOne) SetNick(s string) *MemberUpdateOne {
	muo.mutation.SetNick(s)
	return muo
}

// SetNillableNick sets the "nick" field if the given value is not nil.
func (muo *MemberUpdateOne) SetNillableNick(s *string) *MemberUpdateOne {
	if s != nil {
		muo.SetNick(*s)
	}
	return muo
...
// SetTeam sets the "team" field.
func (muo *MemberUpdateOne) SetTeam(s string) *MemberUpdateOne {
	muo.mutation.SetTeam(s)
	return muo
}

// SetNillableTeam sets the "team" field if the given value is not nil.
func (muo *MemberUpdateOne) SetNillableTeam(s *string) *MemberUpdateOne {
	if s != nil {
		muo.SetTeam(*s)
	}
	return muo
...
// SetDetail sets the "detail" field.
func (muo *MemberUpdateOne) SetDetail(s string) *MemberUpdateOne {
	muo.mutation.SetDetail(s)
	return muo
}

// SetNillableDetail sets the "detail" field if the given value is not nil.
func (muo *MemberUpdateOne) SetNillableDetail(s *string) *MemberUpdateOne {
	if s != nil {
		muo.SetDetail(*s)
	}
	return muo
...
// SetImg sets the "img" field.
func (muo *MemberUpdateOne) SetImg(s string) *MemberUpdateOne {
	muo.mutation.SetImg(s)
	return muo
}

// SetNillableImg sets the "img" field if the given value is not nil.
func (muo *MemberUpdateOne) SetNillableImg(s *string) *MemberUpdateOne {
	if s != nil {
		muo.SetImg(*s)
	}
	return muo
...
func (muo *MemberUpdateOne) sqlSave(ctx context.Context) (_node *Member, err error) {
	...
	if value, ok := muo.mutation.Nick(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: member.FieldNick,
	...
	if value, ok := muo.mutation.Img(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: member.FieldImg,
