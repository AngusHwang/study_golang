...
func (m *MemberQuery) collectField(ctx context.Context, op *graphql.OperationContext, field graphql.CollectedField, path []string, satisfies ...string) error {
...
func newMemberPaginateArgs(rv map[string]interface{}) *memberPaginateArgs {
